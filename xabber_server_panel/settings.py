...
DEBUG = True
EXT_TOOLS = '/home/ilya/Projects/xabber-server-panel-remastered/xabberserver_tools/utils'
EJD_DIR = "/home/ilya/Projects/xabberserver"
...
EJABBERD_STATE = os.path.join('/home/ilya/Projects/xabberserver/', 'server_state')
INSTALLATION_LOCK = os.path.join('/home/ilya/Projects/xabberserver/', '.installation_lock')
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.sqlite3',
#         'NAME': os.path.join('/home/ilya.basyrov/apps/xabberserver/', 'panel.sqlite3'),
#     }
# }
